...
public:
  ...
  int** CreateEnergyMatrix() const;

  int** CreateVerticalDPMatrix(int**& energy_matrix) const;

  int** CreateHorizontalDPMatrix(int**& energy_matrix) const;

  int FindVerticalStartingIndex(int** vertical_dp_matrix) const;

  int FindMinHorizontalStartingIndex(int** horizontal_dp_matrix) const;
