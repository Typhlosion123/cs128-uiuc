...
//  Date ......: 2025/02/28 and later                    Compiler ...: clang++                   //
/////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////
// clang-format on
/////////////////////////////////////////////////////////////////////////////////////////////
...
TEST_CASE("file does not work") {
  REQUIRE_THROWS(ElevationDataset("not_real_file.txt", 2, 5));
}

TEST_CASE("Out of range DatumAT()") {

  ElevationDataset ed = ElevationDataset("example-data/ex_input_data/all-tie-row1-2w-3h.dat", 2, 3);
  REQUIRE_THROWS(ed.DatumAt(5, 5));
}
